...
public class JWKneeModelNet30RND01 extends RootModel {
   ...
   PolygonalMesh FemurCartCollision, TibiaCartCollision, PatellaCartCollision,
   MeniscusCollision;
   // PolygonalMesh for Intersection Check
   PolygonalMesh IntersectionFemurPatella, IntersectionFemurMeniscus,
   IntersectionTibiaMeniscus;
   // Value for embedded mesh
   FemMeshComp EmbeddedFemurCartCollision, EmbeddedTibiaCartCollision,
   EmbeddedPatellaCartCollision, EmbeddedMeniscusCollision;
   ...
   private void setBackgroundWhite () {
      ...
      FixedMeshBody backgroundPlane =
         new FixedMeshBody ("whiteBackground", planeMesh);
      myMech.addMeshBody (backgroundPlane);
      RotationMatrix3d rot = new RotationMatrix3d ();
      rot.setRpy (0, 0, Math.toRadians (-90));
      // (roll, pitch, yaw)
   ...
   private void addProbeIO () throws IOException {
      // Setting up the tracking controller #####
      FrameMarker Target_Mkr =
         myMech
            .addFrameMarkerWorld (
               Femur, new Point3d (378.60e-3, 1789.80e-3, 781.02e-3)); // 378.59409
      // 1789.7974
      // 781.01996
      RenderProps.setSphericalPoints (Target_Mkr, 1.5e-3, Color.WHITE);

      double startTime = 0; // probe start times
      double stopTime = 3.3; // probe stop times

      double x0 = 364.72946e-3; // initial x coordinate of the Hip marker for
                                // point
      // PointExciter 364.72946 1816.1625 783.08197
      double y0 = 1816.1625e-3; // initial y coordinate of the Hip marker for
                                // point
      // PointExciter
      double z0 = 783.08197e-3; // initial z coordinate of the Hip marker for
                                // point
      // PointExciter

      double kx0 = 359.93979e-3; // initial x coordinate of the knee marker for
      // point PointExciter 359.93979 1377.0413
      // 849.25525
      double ky0 = 1377.0413e-3; // initial y coordinate of the knee marker for
      // point PointExciter
      double kz0 = 849.25525e-3; // initial z coordinate of the knee marker for
      // point PointExciter
      ...
      FrameMarker pK =
         myMech.addFrameMarker (Femur, new Point3d (kx0, ky0, kz0));
      ...
      String myCSVPath =
         maspack.util.PathFinder
            .getSourceRelativePath (this, "data/H_Target_Position_MA.txt");
      ...
      targetprobe.scaleNumericList (1e-3);
      ...
      addPointExciter (tcon, pH, ForceDof.FZ, 1000, 0.2, "HZ"); // this one
                                                                // prevents
                                                                // tipping
                                                                // over to
                                                                // the side
      ...
      addFrameExciter (
         tcon, TibiaFibula, WrenchDof.FZ, 1000, 0.05, "TibiaFrameZ");
      addFrameExciter (
         tcon, TibiaFibula, WrenchDof.FX, 1000, 0.05, "TibiaFrameX");
      ...
      // add tracing probes to view the tracking target (cyan) and the actual
      // tracked position (red).
      ...
      addBreakPoint (4.0);
      // geometry notes top: 357.21875 1817.0209 784.27704 bot: 390 965 850 --->
      // h=852 z=frontal richtung x=medial y=up
      // Add a probe to monitor or collect specific data during the simulation
      addProbe ();
   }

   private void addSpringTissues () {
      // Import ligaments
      ...
      //
      // // Import Muscle
      // MultiPointSpring bifem = addBicepsFemorisMuscle ();
      // bifem.scaleDistance (1e-3);
      // MultiPointSpring semiten = addSemitendinosusMuscle ();
      // semiten.scaleDistance (1e-3);
      // MultiPointSpring sol = addSoleusMuscle ();
      // sol.scaleDistance (1e-3);
      // MultiPointSpring[] gasm = addGastrocnemiusMuscles ();
      // gasm[0].scaleDistance (1e-3);
      // gasm[1].scaleDistance (1e-3);
      // MultiPointSpring tibant = addTibialisAnteriorMuscle ();
      // tibant.scaleDistance (1e-3);
      // addMuscle (Femur, Patella);
      //
      // // Meniscus Ligament ####################
      //
      // // Transverse Ligament: n10,n5955 379.65167 1358.1027 862.36358 and
      // // 345.50379 1358.9717 854.44787 d= 35.06
      // FemNode3d MTL1 = meshMeniscus.getNode (10);
      // FemNode3d MTL2 = meshMeniscus.getNode (5955);
      // MultiPointSpring MTL =
      // new MultiPointSpring ("Meniscus Transverse Ligament");
      // MTL.addPoint (MTL1);
      // MTL.addPoint (MTL2);
      ...
      //
      // // Medial Meniscal Anterior Root Ligament n7,n2946 380.17184 1356.9142
      // // 863.49374 and 367.81818 1351.5483 867.25482 (tibia) d=13.99
      // FemNode3d MMARL1 = meshMeniscus.getNode (7);
      // Point3d MMARLPointOnBody =
      // new Point3d (367.81818e-3, 1351.5483e-3, 867.25482e-3);
      // FrameMarker MMARL2 = new FrameMarker ();
      // myMech.addFrameMarker (MMARL2, TibiaFibula, MMARLPointOnBody);
      // MultiPointSpring MMARL =
      // new MultiPointSpring ("Medial Meniscal Anterior Root Ligament");
      ...
      //
      // // Medial Meniscal Posterior Root Ligament n76, n8766 372.92001
      // 1361.5133
      // // 827.97372 and 357.3945 1360.1871 833.15985 (tibia) d=16.42
      // FemNode3d MMPRL1 = meshMeniscus.getNode (76);
      // Point3d MMPRLPointOnBody =
      // new Point3d (357.3945e-3, 1360.1871e-3, 833.15985e-3);
      // FrameMarker MMPRL2 = new FrameMarker ();
      // myMech.addFrameMarker (MMPRL2, TibiaFibula, MMPRLPointOnBody);
      // MultiPointSpring MMPRL =
      // new MultiPointSpring ("Medial Meniscal Posterior Root Ligament");
      ...
      //
      // // Lateral Meniscal Posterior Root Ligament n5723, n8842 350.76427
      // // 1362.102 826.95961 and 363.44931 1361.9719 836.72845 d=16.01
      // FemNode3d LMPRL1 = meshMeniscus.getNode (5723);
      // Point3d LMPRLPointOnBody =
      // new Point3d (363.44931e-3, 1361.9719e-3, 836.72845e-3);
      // FrameMarker LMPRL2 = new FrameMarker ();
      // myMech.addFrameMarker (LMPRL2, TibiaFibula, LMPRLPointOnBody);
      // MultiPointSpring LMPRL =
      // new MultiPointSpring ("Lateral Meniscal Posterior Root Ligament");
      ...
      //
      // // Lateral Meniscal Anterior Root Ligament n5106,n8841 346.37848
      // 1359.6295
      // // 850.64185 and 364.20004 1361.462 845.92108 d=18.52
      // FemNode3d LMARL1 = meshMeniscus.getNode (5106);
      // Point3d LMARLPointOnBody =
      // new Point3d (364.20004e-3, 1361.462e-3, 845.92108e-3);
      // FrameMarker LMARL2 = new FrameMarker ();
      // myMech.addFrameMarker (LMARL2, TibiaFibula, LMARLPointOnBody);
      // MultiPointSpring LMARL =
      // new MultiPointSpring ("Lateral Meniscal Anterior Root Ligament");
      ...
      //
      // // Posterior MeniscoFemoral Ligament n5725, n636 349.66889 1365.8246
      // // 823.37004 and 369.18301 1377.5077 842.44153 (femur) d=29.68
      // FemNode3d PMFL1 = meshMeniscus.getNode (5725);
      // Point3d PMFLPointOnBody =
      // new Point3d (369.18301e-3, 1377.5077e-3, 842.44153e-3);
      // FrameMarker PMFL2 = new FrameMarker ();
      // myMech.addFrameMarker (PMFL2, TibiaFibula, PMFLPointOnBody);
      // MultiPointSpring PMFL =
      // new MultiPointSpring ("Posterior MeniscoFemoral Ligament");
      // PMFL.addPoint (PMFL1);
      // PMFL.addPoint (PMFL2);
      ...
      //
      // // Anterior MeniscoFemoral Ligament n5736, n3107 350.65588 1364.8883
      // // 825.89853 and 364.12494 1374.2969 851.49683(femur) d=30.41
      // FemNode3d AMFL1 = meshMeniscus.getNode (5736);
      // Point3d AMFLPointOnBody =
      // new Point3d (364.12494e-3, 1374.2969e-3, 851.49683e-3);
      // FrameMarker AMFL2 = new FrameMarker ();
      // myMech.addFrameMarker (AMFL2, TibiaFibula, AMFLPointOnBody);
      // MultiPointSpring AMFL =
      // new MultiPointSpring ("Anterior MeniscoFemoral Ligament");
      // AMFL.addPoint (AMFL1);
      // AMFL.addPoint (AMFL2);
      ...
      //
      // cuneiforme = new Particle ("Cuneiforme", 0, 390.0e-3, 965.0e-3,
      // 850.0e-3);
      // cuneiforme.setName ("MTA_insertion");
      // myMech.addParticle (cuneiforme);
      // RenderProps.setSphericalPoints (cuneiforme, 2.0e-3, Color.YELLOW);
   ...
   private void addCollisions () {
      ...
      // critically damping ≈ 2 * sqrt( (1/compliance) * mass)
      double comp = 1e-6;
      // double mass = Femur.getMass () + Patella.getMass ();
      // setCollisionBehavior (
      // Femur, EmbeddedPatellaCartCollision, 0, comp,
      // 2 * sqrt ((1 / comp) * mass));
      // mass = Femur.getMass () + Patella.getMass ();
      // setCollisionBehavior (
      // Femur, Patella, 0, comp, 2 * sqrt ((1 / comp) * mass));
      // setCollisionBehavior (
      // EmbeddedFemurCartCollision, EmbeddedPatellaCartCollision, 0, comp,
      // 2 * sqrt ((1 / comp) * mass));
      double mass = Femur.getMass () + TibiaFibula.getMass ();
      // setCollisionBehavior (
      // EmbeddedFemurCartCollision, EmbeddedMeniscusCollision, 0, comp,
      // 2 * sqrt ((1 / comp) * mass));
      setCollisionBehavior (
         EmbeddedFemurCartCollision, EmbeddedTibiaCartCollision, 0, comp,
         2 * sqrt ((1 / comp) * mass));
      // setCollisionBehavior (
      // EmbeddedTibiaCartCollision, EmbeddedMeniscusCollision, 0, comp,
      // 2 * sqrt ((1 / comp) * mass));
      // mass = Patella.getMass () + TibiaFibula.getMass ();
      // setCollisionBehavior (
      // EmbeddedPatellaCartCollision, EmbeddedTibiaCartCollision, 0, comp,
      // 2 * sqrt ((1 / comp) * mass));
      setCollisionManager ();
      /*
       * setCollisionBehavior (Femur, EmbeddedPatellaCartCollision, 0, 0.3e-8,
       * 1e8); setCollisionBehavior (Femur, Patella, 0, 1e-9, 1.5e8); //does it
       * matter? setCollisionBehavior (EmbeddedFemurCartCollision,
       * EmbeddedPatellaCartCollision, 0, 0.6e-9 , 1.5e8); setCollisionBehavior
       * (EmbeddedFemurCartCollision, EmbeddedMeniscusCollision, 0, 0.2e-8 ,
       * 1.5e8); setCollisionBehavior (EmbeddedFemurCartCollision,
       * EmbeddedTibiaCartCollision, 0, 0.3e-9 , 1.5e8); setCollisionBehavior
       * (EmbeddedPatellaCartCollision, EmbeddedTibiaCartCollision, 0, 0.3e-9 ,
       * 1.5e8); setCollisionBehavior (EmbeddedTibiaCartCollision,
       * EmbeddedMeniscusCollision, 0, 0.2e-8 , 1.5e8);
       */
   }

   private void connectFEToRB () {
   ...
   private void importFEMeshes () throws IOException {
      // Import FEM-models
      meshFemurCart =
         importFemModel (
            "FemurCart_m30.cdb", "FemurCart", 1.15e3, // density in kg/m³
            0.01, // mass damping
            1, // stiffness damping
            new LinearMaterial (
               /* Young's modulu(Pa): */5e7, /* Poisson's ratio: */ 0.45));

      EmbeddedFemurCartCollision =
         meshFemurCart.addMesh ("FemurCartCollision", FemurCartCollision);
      ...
      RenderProps
         .setFaceColor (
            EmbeddedFemurCartCollision, new Color (0.8f, 0.5f, 0.6f));
      RenderProps.setAlpha (EmbeddedFemurCartCollision, 0.5); // opaque

      meshTibiaCart =
         importFemModel (
            "TibiaCart_m30.cdb", "TibiaCart", 1.15e3, // density in kg/m³
            0.01, // mass damping
            1, // stiffness damping
            new LinearMaterial (
               /* Young's modulu(Pa): */5e7, /* Poisson's ratio: */ 0.45));

      EmbeddedTibiaCartCollision =
         meshTibiaCart.addMesh ("TibiaCartCollision", TibiaCartCollision);
      ...
      RenderProps
         .setFaceColor (
            EmbeddedTibiaCartCollision, new Color (0.8f, 0.5f, 0.6f));
      RenderProps.setAlpha (EmbeddedTibiaCartCollision, 0.5); // opaque

      // meshPatellaCart =
      // importFemModel (
      // "PatellaCart_m30.cdb", "PatellaCart", 1.15e3, // density in kg/m³
      // 0.01, // mass damping
      // 1, // stiffness damping
      // new LinearMaterial (
      // /* Young's modulu(50 MPa): */5e7, /* Poisson's ratio: */ 0.45));

      // EmbeddedPatellaCartCollision =
      // meshPatellaCart.addMesh ("PatellaCartCollision", PatellaCartCollision);
      // EmbeddedPatellaCartCollision.setSurfaceRendering
      // (SurfaceRender.Shaded);
      // EmbeddedPatellaCartCollision.setCollidable (Collidability.EXTERNAL);
      // RenderProps
      // .setFaceColor (
      // EmbeddedPatellaCartCollision, new Color (0.9f, 0.4f, 0.4f));
      // RenderProps.setAlpha (EmbeddedPatellaCartCollision, 0.5); // opaque
      //
      // meshMeniscus =
      // importFemModel (
      // "Meniscus_m30.cdb", "Meniscus", 1.1e3, // density in kg/m³
      // 0.01, // mass damping
      // 1, // stiffness damping
      // new LinearMaterial (
      // /* Young's modulu(MPa): */5e7, /* Poisson's ratio: */ 0.45));
      // //RenderProps.setSphericalPoints (meshMeniscus, 0.2, Color.CYAN);
      //
      // EmbeddedMeniscusCollision =
      // meshMeniscus.addMesh ("MeniscusLatCartCollision", MeniscusCollision);
      ...
      // RenderProps
      // .setFaceColor (
      // EmbeddedMeniscusCollision, new Color (0.8f, 0.5f, 0.6f));
      // RenderProps.setAlpha (EmbeddedMeniscusCollision, 0.0); // opaque

      // //Check forIntersection
      // IntersectionFemurPatella =
      // MeshFactory.getIntersection (FemurCartCollision, PatellaCartCollision);
      ...
      // FixedMeshBody IntersectionFemurPatellabody =
      // new FixedMeshBody (
      // "IntersectionFemurPatella", IntersectionFemurPatella);
      // myMech.addMeshBody (IntersectionFemurPatellabody);
      //
      // IntersectionFemurMeniscus =
      // MeshFactory.getIntersection (FemurCartCollision, MeniscusCollision);
      ...
      // FixedMeshBody IntersectionFemurMeniscusbody =
      // new FixedMeshBody (
      // "IntersectionFemurMeniscus", IntersectionFemurMeniscus);
      // myMech.addMeshBody (IntersectionFemurMeniscusbody);
      //
      // IntersectionTibiaMeniscus =
      // MeshFactory.getIntersection (TibiaCartCollision, MeniscusCollision);
      ...
      // FixedMeshBody IntersectionTibiaMeniscusbody =
      // new FixedMeshBody (
      // "IntersectionTibiaMeniscus", IntersectionTibiaMeniscus);
      // myMech.addMeshBody (IntersectionTibiaMeniscusbody);
   }

   private void importCollisionMeshes () throws IOException {
      FemurCartCollision =
         new PolygonalMesh (myPath + "FemurCartCollision_m30ppp.obj");
      FemurCartCollision.scale (1e-3);
      TibiaCartCollision =
         new PolygonalMesh (myPath + "TibiaCartCollision_m30ppp.obj");
      TibiaCartCollision.scale (1e-3);
      // PatellaCartCollision =
      // new PolygonalMesh (myPath + "PatellaCartCollision_m30ppp.obj");
      // PatellaCartCollision.scale (1e-3);
      // MeniscusCollision =
      // new PolygonalMesh (myPath + "MeniscusCollision_m30ppp.obj");
      // MeniscusCollision.scale (1e-3);
  
      // move it (to avoid Intersection ) 
      RigidTransform3d moveitup = new RigidTransform3d (0.0, 0.36e-3, 0.0);
      FemurCartCollision.transform (moveitup);

      // RigidTransform3d moveitforward = new RigidTransform3d (0.0, 0,
      // 0.49e-3);
      // PatellaCartCollision.transform (moveitforward);

      RigidTransform3d moveitdown = new RigidTransform3d (0.0, -0.32e-3, 0.0);
      TibiaCartCollision.transform (moveitdown);

      // but the meshes are not build by triangles !!! ---> mesh must be
      // triangulated
   ...
   private void importRigidBodies () throws IOException {
      ...
      Femur = importRigidBody ("femur.obj", "Femur", /* kg/m^3 */ 1.3e-3);
      Femur.scaleDistance (1e-3);
      Femur.scaleMass (1e-3);
      TibiaFibula = importRigidBody ("tibia.obj", "TibiaFibula", 1.3e-3);
      TibiaFibula.scaleDistance (1e-3);
      TibiaFibula.scaleMass (1e-3);
      // Patella = importRigidBody ("patella.obj", "Patella", 1.3e-3);
      // Patella.scaleDistance (1e-3);
      // Patella.scaleMass (1e-3);

      // create Forces
      Point3d ForcePointW = new Point3d (354.53e-3, 1815.51e-3, 772.74e-3);
      FrameMarker mkrW = myMech.addFrameMarker (Femur, ForcePointW);
      // 343.35N
      // (70Kg*9,81m/(s*s)*0.5)
      Vector3d VectorFW = new Vector3d (0, -343.35, 0);
      PointForce ForceVectorFW = new PointForce (VectorFW, mkrW);
      ForceVectorFW.setAxisRadiusRatio (0.01);
      ForceVectorFW.setAxisLength (0.1);
   ...
   private void setSimulationProperties () {
      ...
      setMinStepSize (1e-7); // test? normal -7
   ...
   void addPointExciter (
      TrackingController tcon, Point point, ForceDof dof, double maxf,
      double weight, String name) {
   ...
   private void setFemRenderProps (FemModel3d fem) {
      ...
      fem.setStressPlotRange (new DoubleInterval (0.0, 100000000));
   ...
   private void addAnterolateralLigament () {
      MultiPointSpring ALL =
         createLigament (
            "ALL", Femur, new Point3d (325e-3, 1377e-3, 842e-3), TibiaFibula,
            new Point3d (324e-3, 1352e-3, 844e-3), 795, 15e-3, 0.00);
   }

   // Anterior Cruciate Ligament (ACL) - Two Bundles
   private void addAnteriorCruciateLigament () {
      // Anterior bundle
      MultiPointSpring aACL =
         createLigament (
            "aACL", Femur, new Point3d (356e-3, 1384e-3, 834e-3), TibiaFibula,
            new Point3d (362e-3, 1357e-3, 853e-3), 6200, 32.3e-3, 0.00);
      // Posterior bundle
      MultiPointSpring pACL =
         createLigament (
            "pACL", Femur, new Point3d (356e-3, 1379e-3, 832e-3), TibiaFibula,
            new Point3d (358e-3, 1357e-3, 850e-3), 3400, 26.6e-3, 0.00);
   }

   // Lateral Collateral Ligament (LCL) Complex
   private void addLateralCollateralLigament () {
      // Anterior part
      MultiPointSpring aLCL =
         createLigament (
            "aLCL", Femur, new Point3d (326e-3, 1381e-3, 841e-3), TibiaFibula,
            new Point3d (311e-3, 1328e-3, 829e-3), 2000, 45e-3, 0.00);

      // Middle part
      MultiPointSpring mLCL =
         createLigament (
            "mLCL", Femur, new Point3d (327e-3, 1381e-3, 837e-3), TibiaFibula,
            new Point3d (311e-3, 1328e-3, 825e-3), 2000, 40.2e-3, 0.00);

      // Posterior part
      MultiPointSpring pLCL =
         createLigament (
            "pLCL", Femur, new Point3d (329e-3, 1380e-3, 833e-3), TibiaFibula,
            new Point3d (313e-3, 1331e-3, 823e-3), 2000, 40.2e-3, 0.00);
   }

   // Medial Collateral Ligament (MCL) Complex
   private void addMedialCollateralLigamentComplex () {
      // Deep MCL - Anterior part
      MultiPointSpring adMCL =
         createLigament (
            "adMCL", Femur, new Point3d (398e-3, 1381e-3, 847e-3), TibiaFibula,
            new Point3d (394e-3, 1349e-3, 848e-3), 1500, 27.2e-3, 0.00);
      // Deep MCL - Posterior part
      MultiPointSpring pdMCL =
         createLigament (
            "pdMCL", Femur, new Point3d (398e-3, 1382e-3, 838e-3), TibiaFibula,
            new Point3d (395e-3, 1348e-3, 838e-3), 1500, 23.8e-3, 0.00);
      // Superficial MCL - Anterior part (3-point ligament)
      MultiPointSpring asMCL =
         createLigament (
            "asMCL", Femur, new Point3d (398e-3, 1384e-3, 849e-3), TibiaFibula,
            new Point3d (375e-3, 1301e-3, 851e-3),
            /* via point */ new Point3d (395e-3, 1345e-3, 850e-3), 2500,
            40.3e-3, 0.00);
      // Superficial MCL - Middle part (3-point ligament)
      MultiPointSpring msMCL =
         createLigament (
            "msMCL", Femur, new Point3d (399e-3, 1385e-3, 845e-3), TibiaFibula,
            new Point3d (376e-3, 1297e-3, 848e-3),
            /* via point */new Point3d (395e-3, 1345e-3, 847e-3), 2600, 38.6e-3,
            0.0);
      // Superficial MCL - Posterior part (3-point ligament)
      MultiPointSpring psMCL =
         createLigament (
            "psMCL", Femur, new Point3d (399e-3, 1384e-3, 840e-3), TibiaFibula,
            new Point3d (376, 1293, 846),
            /* via point */new Point3d (396e-3, 1345e-3, 844e-3), 2700, 37.1e-3,
            0.0);
   }
   ...
   private void addPosteriorCruciateLigament () {
      // Anterior bundle
      MultiPointSpring aPCL =
         createLigament (
            "aPCL", Femur, new Point3d (365, 1377, 849), TibiaFibula,
            new Point3d (360, 1354, 828), 12500000, 39.7, 1.0);
      aPCL.scaleDistance (1e-3);

      // Posterior bundle
      MultiPointSpring pPCL =
         createLigament (
            "pPCL", Femur, new Point3d (370, 1374, 842), TibiaFibula,
            new Point3d (362, 1350, 825), 1500000, 38.4, 1.0);
      pPCL.scaleDistance (1e-3);
   }

   // Popliteus Oblique Ligament (POL)
   private void addPopliteusObliqueLigament () {
      MultiPointSpring POL =
         createLigament (
            "POL", Femur, new Point3d (399, 1388, 836), TibiaFibula,
            new Point3d (393, 1343, 828), 1600000, 44.8, 1.0);
      POL.scaleDistance (1e-3);
   }

   // Patellar Ligaments (Kges=1000 N/mm)
   private void addPatellarLigaments () {
      // Lateral patellar ligament
      MultiPointSpring lPL =
         createLigament (
            "lPL", Patella, new Point3d (347, 1382, 895), TibiaFibula,
            new Point3d (350, 1326, 869), 33300000, 55.8, 10.0);
      lPL.scaleDistance (1e-3);

      // Central patellar ligament
      MultiPointSpring cPL =
         createLigament (
            "cPL", Patella, new Point3d (356, 1373, 894), TibiaFibula,
            new Point3d (359, 1328, 871), 33300000, 45.6, 10.0);
      cPL.scaleDistance (1e-3);
      // Medial patellar ligament
      MultiPointSpring mPL =
         createLigament (
            "mPL", Patella, new Point3d (364, 1381, 897), TibiaFibula,
            new Point3d (364, 1331, 870), 33300000, 50.0, 10.0);
      mPL.scaleDistance (1e-3);
      // 374.33295 1400.506 898.52448 patella m 397.57446 1398.1603 840.43719
      // Femur m
      // 334.75906 1401.676 890.80017 patella l 328.79553 1393.6785 836.6507
      // Femur L

      // Medial patellofemoral ligament
      MultiPointSpring mPFL =
         createLigament (
            "mPFL", Patella, new Point3d (374, 1400, 899), Femur,
            new Point3d (398, 1398, 840), new Point3d (403, 1398, 850), 20000,
            60.91, 5.0);
      mPFL.scaleDistance (1e-3);
      // Lateral patellofemoral ligament
      MultiPointSpring lPFL =
         createLigament (
            "lPFL", Patella, new Point3d (335, 1402, 891), Femur,
            new Point3d (329, 1394, 837), new Point3d (324, 1394, 847), 20000,
            54.92, 5.0);
      lPFL.scaleDistance (1e-3);
   }
   ...
   private void addAchillesTendon () {
      ...
      Particle achillesPoint =
         new Particle ("AchillesPoint", 0.01, 390.0, 1100.0, 800.0);
      ...
      double initialDistance =
         calcaneus.getPosition ().distance (achillesPoint.getPosition ());
      ...
      achillesTendon
         .setMaterial (
            new Blankevoort1991AxialLigament (
               stiffness, referenceLength, damping));

      // Add the tendon to the mechanical model
      myMech.addMultiPointSpring (achillesTendon);
      achillesTendon.scaleDistance (1e-3);
      // Set rendering properties for the tendon
      RenderProps
         .setCylindricalLines (
            achillesTendon, 1.5e-3, new Color (0.9f, 0.7f, 0.2f));
      RenderProps.setVisible (achillesTendon, true);

      System.out
         .println (
            "Achilles tendon added with reference length: " + referenceLength
            + " mm");
   }

   private MultiPointSpring createLigament (
      String name, RigidBody bodyA, Point3d pointA, RigidBody bodyB,
      Point3d pointB, double stiffness, double refLength, double damping) {
      ...
      ligament
         .setMaterial (
            new Blankevoort1991AxialLigament (stiffness, refLength, damping));

      // Set consistent render properties
      RenderProps.setSphericalPoints (markerA, 1e-3, Color.BLUE);
      RenderProps.setSphericalPoints (markerB, 1e-3, Color.BLUE);
      RenderProps.setCylindricalLines (ligament, 0.3e-3, Color.WHITE);
   ...
   private MultiPointSpring createLigament (
      String name, RigidBody bodyA, Point3d pointA, RigidBody bodyB,
      Point3d pointB, Point3d pointVia, // Via point parameters
      ...
      ligament
         .setMaterial (
            new Blankevoort1991AxialLigament (stiffness, refLength, damping));
      ligament.updateWrapSegments (); // ‘‘ shrink wrap ’’ spring to the
                                      // obstacles

      RenderProps.setSphericalPoints (markerA, 1e-3, Color.BLUE);
      RenderProps.setSphericalPoints (markerB, 1e-3, Color.BLUE);
      RenderProps.setSphericalPoints (particleVia, 1e-3, Color.GREEN);
      RenderProps.setCylindricalLines (ligament, 0.3e-3, Color.WHITE);
   ...
   private void addMuscle (RigidBody femur, RigidBody patella) {
      ...
      FrameMarker vastusLateralisOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (326.85349, 1587.8762, 845.98602));
      vastusLateralisOrigin.setName (" Vastus_Lateralis_Origin");
      FrameMarker vastusLateralisInsertion =
         myMech
            .addFrameMarker (
               Patella, new Point3d (343.9282, 1410.4975, 894.20783));
      ...
      RenderProps
         .setSphericalPoints (vastusLateralisInsertion, 2.5, Color.GREEN);

      MultiPointSpring vastusLateralis =
         new MultiPointSpring ("Vastus_Lateralis");
      ...
      vastusLateralis.scaleDistance (1e-3);

      FrameMarker rectusFemorisOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (341.85349, 1587.8762, 845.98602));
      rectusFemorisOrigin.setName (" Rectus_Femoris_Origin");
      FrameMarker rectusFemorisInsertion =
         myMech
            .addFrameMarker (
               Patella, new Point3d (355.54824, 1407.7581, 899.18102));
      ...
      rectusFemoris.scaleDistance (1e-3);

      FrameMarker vastusMedialisOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (356.85349, 1587.8762, 845.98602));
      vastusMedialisOrigin.setName (" Vastus_Medialis_Origin");
      FrameMarker vastusMedialisInsertion =
         myMech
            .addFrameMarker (
               Patella, new Point3d (367.64791, 1410.5255, 895.69954));
      ...
      RenderProps
         .setSphericalPoints (vastusMedialisInsertion, 2.5, Color.GREEN);

      MultiPointSpring vastusMedialis =
         new MultiPointSpring ("Vastus_Medialis");
      ...
      vastusMedialis.scaleDistance (1e-3);
   }
   // Lateral:M. biceps femoris Medial M. semitendinosus & M. semimembranosus
   // 324.46405 1343.5797 822.58936 TibiaFibula 334.84143 1664.3613 784.50519
   // Femur
   // 384.92139 1346.5948 822.41791 TibiaFiibula 337.82068 1694.3103 775.97101
   // Femur

   private MultiPointSpring addSemitendinosusMuscle () {

      FrameMarker semitendinosusTibialInsertion =
         myMech
            .addFrameMarker (
               TibiaFibula, new Point3d (384.92139, 1346.5948, 822.41791));
      semitendinosusTibialInsertion.setName ("Semitendinosus_Tibial_Insertion");
      FrameMarker semitendinosusFemoralOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (375.82068, 1694.3103, 765.97101));
      semitendinosusFemoralOrigin.setName ("Semitendinosus_Femoral_Origin");
      RenderProps
         .setSphericalPoints (semitendinosusTibialInsertion, 2.5, Color.GREEN);
      RenderProps
         .setSphericalPoints (semitendinosusFemoralOrigin, 2.5, Color.GREEN);
   ...
   private MultiPointSpring addBicepsFemorisMuscle () {
      ...
      FrameMarker bicepsTibialInsertion =
         myMech
            .addFrameMarker (
               TibiaFibula, new Point3d (324.46405, 1343.5797, 822.58936));
      bicepsTibialInsertion.setName ("Biceps_Tibial_Insertion");
      FrameMarker bicepsFemoralOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (360.84143, 1694.3613, 774.50519));
   ...
   private MultiPointSpring addSoleusMuscle () {
      FrameMarker soleusTibialInsertion =
         myMech
            .addFrameMarker (
               TibiaFibula, new Point3d (364.1702, 1264.9733, 827.86859));
   ...
   private MultiPointSpring[] addGastrocnemiusMuscles () {

      FrameMarker gastrocLatOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (343.21899, 1395.6849, 825.1441));
      gastrocLatOrigin.setName ("Gastroc_Lat_Origin");
      RenderProps.setSphericalPoints (gastrocLatOrigin, 2.5, Color.GREEN);

      FrameMarker gastrocMedOrigin =
         myMech
            .addFrameMarker (
               Femur, new Point3d (382.71698, 1395.064, 829.1026));
      gastrocMedOrigin.setName ("Gastroc_Med_Origin");
      RenderProps.setSphericalPoints (gastrocMedOrigin, 2.5, Color.GREEN);

      MultiPointSpring gastrocLat =
         new MultiPointSpring ("Gastrocnemius_Lateral");

      FrameMarker gastrocLatVia1 =
         myMech
            .addFrameMarker (
               Femur, new Point3d (343.21899, 1398.6849, 819.1441));
      gastrocLatVia1.setName ("Gastroc_Lat_Via1");
      RenderProps.setSphericalPoints (gastrocLatVia1, 1.5, Color.CYAN);

      FrameMarker gastrocLatVia2 =
         myMech
            .addFrameMarker (
               Femur, new Point3d (343.21899, 1395.6849, 814.1441));
      gastrocLatVia2.setName ("Gastroc_Lat_Via2");
      RenderProps.setSphericalPoints (gastrocLatVia2, 1.5, Color.CYAN);

      FrameMarker gastrocMedVia1 =
         myMech
            .addFrameMarker (
               Femur, new Point3d (382.71698, 1398.064, 822.1026));
      gastrocMedVia1.setName ("Gastroc_Med_Via1");
      RenderProps.setSphericalPoints (gastrocMedVia1, 1.5, Color.CYAN);

      FrameMarker gastrocMedVia2 =
         myMech
            .addFrameMarker (
               Femur, new Point3d (382.71698, 1395.064, 816.1026));
      ...
      MultiPointSpring gastrocMed =
         new MultiPointSpring ("Gastrocnemius_Medial");
      ...
      return new MultiPointSpring[] { gastrocLat, gastrocMed };
   }

   private MultiPointSpring addTibialisAnteriorMuscle () {

      FrameMarker tibAntOrigin =
         myMech
            .addFrameMarker (
               TibiaFibula, new Point3d (345.33441, 1312.1631, 841.00348));
      tibAntOrigin.setName ("Tibialis_Anterior_Origin");
      RenderProps.setSphericalPoints (tibAntOrigin, 2.5, Color.GREEN);

      MultiPointSpring tibialisAnterior =
         new MultiPointSpring ("Tibialis_Anterior");
      ...
      return tibialisAnterior;
   }

   // #############################################################################################################################

   private JointBase createHingeJointToGround (ConnectableBody body) {
      Vector3d origin = new Vector3d (365e-3, 967e-3, 800e-3);
   ...
   private void setJointCompliance (
      JointBase joint, double rotCompliance, double rotDamping,
      double lockCompliance, double lockDamping) {
   ...
   private void setJointRenderProps (JointBase joint) {
      joint.setShaftLength (70e-3);
      joint.setShaftRadius (1e-3);
      joint.setAxisLength (50e-3);
   ...
   private void setCollisionBehavior (
      ...
      behavior.setColliderType (CollisionManager.ColliderType.TRI_INTERSECTION);
      behavior.setBilateralVertexContact (true);
      behavior.setMethod (CollisionBehavior.Method.VERTEX_PENETRATION);
   ...
   /*
    * private void setCollisionBehavior ( Collidable body1, Collidable body2,
    * double mu, double compliance, double damping) { CollisionBehavior behavior
    * = new CollisionBehavior (true, mu); behavior.setCompliance (compliance);
    * behavior.setDamping (damping); myMech.setCollisionBehavior (body1, body2,
    * behavior); }
    * 
    * private void setCollisionManager () { CollisionManager cm =
    * myMech.getCollisionManager (); RenderProps.setVisible (cm, true);
    * cm.setDrawContactForces (false); cm.setDrawFrictionForces (false);
    * cm.setContactForceLenScale (0.1); RenderProps.setSolidArrowLines (cm, 0.2,
    * Color.RED); cm.setDrawIntersectionPoints (true);
    * RenderProps.setSphericalPoints (cm, 0.5, Color.GREEN); }
    * 
    * private class ContactMonitor extends MonitorBase { public void apply
    * (double t0, double t1) { // get the contacts from the collision response
    * and print their // positions and forces. List<ContactData> cdata =
    * myResp.getContactData (); if (cdata.size () > 0) { System.out .println
    * ("num contacts: " + cdata.size () + ", time=" + t0); double contactSum =
    * 0; for (ContactData cd : cdata) { System.out .print (" pos:   " +
    * cd.getPosition0 ().toString ("%8.3f")); System.out .println ( ", force: "
    * + cd.getContactForce ().toString ("%8.1f")); contactSum = contactSum +
    * cd.getContactForceScalar (); } } } }
    */
   ...
   private void initialWriter () throws IOException {
      try {
         writerStress =
            new PrintWriter (
               new FileWriter (myPath + "output/Stress.txt", true));
         writerStrain =
            new PrintWriter (
               new FileWriter (myPath + "output/Strain.txt", true));
         writerMises =
            new PrintWriter (
               new FileWriter (myPath + "output/VonMisesStress.txt", true));

         // Headers
         writerStress
            .println ("=== Stress Data for Randomly Selected Nodes ===");
         writerStress.println ("Target Nodes: " + targetNodeNumbers);
         writerStress.println ("Format: Time[s], NodeID, StressTensor");

         writerStrain
            .println ("=== Strain Data for Randomly Selected Nodes ===");
   ...
   private void addProbe () throws IOException {
      ...
      NumericMonitorProbe StressProbe =
         new NumericMonitorProbe (
      ...
      NumericMonitorProbe StrainProbe =
         new NumericMonitorProbe (
      ...
      NumericMonitorProbe VonMisesProbe =
         new NumericMonitorProbe (
            targetNodes.size (), myPath + "output/VonMisesStress.dat", 0, 20,
            -1);
   ...
   private void initializeTargetNodes () {
      ...
      System.out
         .println ("Randomly selected " + targetNodes.size () + " nodes:");
      ...
      for (FemNode3d node : targetNodes) {
         ...
         RenderProps.setPointRadius (node, 0.6e-3);
   ...
   public class FEMStressFunction implements DataFunction, Clonable {
      public void eval (VectorNd vec, double t, double trel) {
         ...
         for (FemNode3d n : targetNodes) {
            ...
            writerStress
               .printf (
                  "%.6f   %.6f   %.6f%n", stress.m00, stress.m01, stress.m02);
            writerStress
               .printf (
                  "%.6f   %.6f   %.6f%n", stress.m01, stress.m11, stress.m12);
            writerStress
               .printf (
                  "%.6f   %.6f   %.6f%n", stress.m02, stress.m12, stress.m22);
         }
   ...
   public class FEMStrainFunction implements DataFunction, Clonable {
      public void eval (VectorNd vec, double t, double trel) {
         ...
         for (FemNode3d n : targetNodes) {
            ...
            writerStrain
               .printf (
                  "%.6f   %.6f   %.6f%n", strain.m00, strain.m01, strain.m02);
            writerStrain
               .printf (
                  "%.6f   %.6f   %.6f%n", strain.m01, strain.m11, strain.m12);
            writerStrain
               .printf (
                  "%.6f   %.6f   %.6f%n", strain.m02, strain.m12, strain.m22);
         }
   ...
   public class FEMVonMisesFunction implements DataFunction, Clonable {
      public void eval (VectorNd vec, double t, double trel) {
         for (int i = 0; i < targetNodes.size (); i++) {
            ...
            writerMises
               .printf ("%.3f\t%d\t%.6f%n", t, n.getNumber (), vonMisesStress);
         }
         writerMises.flush ();
      }
